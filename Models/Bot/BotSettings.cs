...
namespace ManchkinGameApi.Models.Bot 
{
    ...
    {
        public override string Url {get;set;} ="https://1ce99bcc.ngrok.io/api/Bot/ManchkinHand/";
        ...
        public override List<Command> Commands {get;set;}= new List<Command>() 
        {
            ...
            new SellMenu(),new Chouse(), new FingtReadyPlayer()
        };
        public override BotEnum BotType {get;set;} = BotEnum.HandBot;
    }
    public  class ManckinGameBotSettings:BotSettings
    {
        public override string Url {get;set;}="https://1ce99bcc.ngrok.io/api/Bot/ManchkinGame/";
